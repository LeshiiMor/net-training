...
namespace Serialization.Tasks
{
    ...
    public class Queries
    {
        ...
        public IEnumerable<NextPage> NextPage { get; set; }
    ...
    public class RTO
    {
        ...
        public string Url2c { get; set; }

        [DataMember(Name = "Output::link2c")]
        public string Link2c { get; set; }
        ...
        public string InlineImageWidth { get; set; }

        [DataMember(Name = "Output::inline_image_height")]
        public string InlineImageHeight { get; set; }

        [DataMember(Name = "Output::image_border")]
        public string ImageBorder { get; set; }
    }
